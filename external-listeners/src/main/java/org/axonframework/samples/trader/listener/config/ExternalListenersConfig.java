...
import org.axonframework.samples.trader.listener.OrderbookExternalListener;
...
public class ExternalListenersConfig {
    ...
    @Autowired
    private OrderbookExternalListener orderbookExternalListener;
